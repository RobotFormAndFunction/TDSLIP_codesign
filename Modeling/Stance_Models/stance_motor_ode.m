function xdot=stance_motor_ode(t,x,IC,robot,simp, motor,func_param,mvar,V,type)
% Inputs:
%
...
% kt, kb, J, C, R];
%
% V voltage matrix where the first column is time and second is the
...
xdot(5,:) =V'./La-Ra*x5./La-R*kb*x4./La;
end